...
export default function AuthorHoverCard({ children, authorId }: AuthorHoverCardProps) {
  ...
  // Reset image load states whenever authorInfo changes (new author)
  ...
  return (
    <HoverCard openDelay={500}>
      ...
      >
        ...
        {/* Content: rendered (but hidden) so images can preload; visible once ready */}
        {authorInfo && (
          <div className={imagesReady ? 'flex flex-col gap-1' : 'hidden'}>
            ...
            {/* Bottom: Button Leads to Author Profile */}
