...
import { CommentItem } from '@/features/me/components/CommentItem';
...
export function CommentSection({ userId }: CommentSectionProps) {
  const { comments, isLoading, isLoadingMore, hasMore, loadMore, error } = useComments(userId, 10);
